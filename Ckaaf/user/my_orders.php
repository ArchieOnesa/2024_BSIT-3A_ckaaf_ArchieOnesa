            ...
            <table width="100%">
                ...
                <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result_order_items)) {
                            if ($current_order_reference != $row['order_reference_number'] && $row['orderStatus'] == 'Pending') {
                                if ($current_order_reference != "") {
                                    ...
                                    echo "<tr class='$row_class'><td colspan='8'>
                                            <form action='cancel_order.php' method='post'>
                                                <input type='hidden' name='order_reference' value='$current_order_reference'>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='8'>No products ordered are found.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
